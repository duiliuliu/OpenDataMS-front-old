  ...
  render() {
    ...
    return (
      <Form onSubmit={this.handleSubmit}>
        ...
        <Form.Item {...formItemLayout} label="URL" hasFeedback>
        ...
        <Form.Item {...formItemLayout} label="数据类目">
        ...
        <Form.Item wrapperCol={{ span: 7, offset: 8 }}>
          ...
          <Button type="danger" htmlType="reset" style={{ margin: 10 }}>
            取消
          </Button>
        </Form.Item>
      </Form>
...
const NewJob = Form.create({ name: "validate_other" })(JobForm);
